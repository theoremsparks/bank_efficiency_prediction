...
OUTPUT_DIR = get_model_output_dir("catboost")
MODEL_DIR = get_model_dir("catboost")
...
def main():
    print("=" * 70)
    print("RUNNING CATBOOST TRAINING")
    print("=" * 70)
    ...
    cv_metrics_df.to_csv(
        OUTPUT_DIR / "cat_cross_validation_metrics.csv",
        index=False,
    )
    ...
    # ==========================================================
    joblib.dump(cat_model, MODEL_DIR / "cat_final_model.joblib")
