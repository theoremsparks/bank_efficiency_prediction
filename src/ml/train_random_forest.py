...
OUTPUT_DIR = get_model_output_dir("random_forest")
MODEL_DIR = get_model_dir("random_forest")
...
def main():
    print("=" * 70)
    print("RUNNING RANDOM FOREST TRAINING")
    print("=" * 70)
    ...
    cv_metrics_df.to_csv(
        OUTPUT_DIR / "rf_cross_validation_metrics.csv",
        index=False,
    )
    ...
    # ==========================================================
    joblib.dump(rf_model, MODEL_DIR / "rf_final_model.joblib")
