...
# Set Directory 
# ==========================================================
OUTPUT_DIR = get_model_output_dir("voting_classifier")
MODEL_DIR = get_model_dir("voting_classifier")
...
def main():
    print("=" * 70)
    print("RUNNING VOTING CLASSIFIER TRAINING")
    print("=" * 70)
    ...
    print("=" * 70)
    print("VOTING TRAINING COMPLETED")
    print("=" * 70)
