...
OUTPUT_DIR = get_model_output_dir("adaboost")
MODEL_DIR = get_model_dir("adaboost")
...
def main():
    print("=" * 70)
    print("RUNNING ADABOOST OPTUNA TRAINING")
    print("=" * 70)
    ...
    cv_metrics_df.to_csv(
        OUTPUT_DIR / "ada_cross_validation_metrics.csv",
        index=False,
    )
    ...
    # ==========================================================
    joblib.dump(ada_model, MODEL_DIR / "ada_final_model.joblib")
