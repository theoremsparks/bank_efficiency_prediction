...
OUTPUT_DIR = get_model_output_dir("bagging_optuna")
MODEL_DIR = get_model_dir("bagging_optuna")
...
def main():
    print("=" * 70)
    print("RUNNING BAGGING OPTUNA TRAINING")
    print("=" * 70)
    ...
    def objective(trial):
        base_estimator = DecisionTreeClassifier(
            max_depth=trial.suggest_int("base_max_depth", 2, 20),
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="bag_multiclass_optuna_macro_f1",
        sampler=sampler
    )
    ...
    optuna_trials_df.to_csv(
        OUTPUT_DIR / "bag_optuna_trials.csv",
        index=False
    )
    ...
    best_params_df.to_csv(
        OUTPUT_DIR / "bag_best_params.csv",
        index=False
    )

    # ==========================================================
    # Train best Bagging classifier
    # ==========================================================
    ...
    # ==========================================================
    joblib.dump(bag_model, MODEL_DIR / "bag_final_optimized_model.joblib")
    ...
    # ==========================================================
    # SHAP Analysis (Average across sampled base estimators)
    # ==========================================================
