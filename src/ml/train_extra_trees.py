...
OUTPUT_DIR = get_model_output_dir("extra_trees")
MODEL_DIR = get_model_dir("extra_trees")
...
def main():
    print("=" * 70)
    print("RUNNING EXTRA TREES TRAINING")
    print("=" * 70)
    ...
    cv_metrics_df.to_csv(
        OUTPUT_DIR / "et_cross_validation_metrics.csv",
        index=False,
    )
    ...
    # ==========================================================
    joblib.dump(et_model, MODEL_DIR / "et_final_model.joblib")
