...
OUTPUT_DIR = get_model_output_dir("xgboost")
...
def main():
    ...
    y = y_original - 1  # XGBoost uses 0-based class labels internally
    ...
    cv_metrics_df.to_csv(
        OUTPUT_DIR / "xgb_cross_validation_metrics.csv",
        index=False,
    )
    ...
    # ==========================================================
    joblib.dump(xgb_model, MODEL_DIR / "xgb_final_model.joblib")
    ...
    macro_precision = precision_score(
        y_test_original, y_pred_original, average="macro", zero_division=0
    )
    ...
    weighted_precision = precision_score(
        y_test_original, y_pred_original, average="weighted", zero_division=0
    )
