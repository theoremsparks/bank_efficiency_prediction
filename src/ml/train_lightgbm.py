...
OUTPUT_DIR = get_model_output_dir("lightgbm")
...
def main():
    print("=" * 70)
    print("RUNNING LIGHTGBM TRAINING")
    print("=" * 70)
    ...
    cv_metrics_df.to_csv(
        OUTPUT_DIR / "lgbm_cross_validation_metrics.csv",
        index=False,
    )
    ...
    # ==========================================================
    joblib.dump(lgbm_model, MODEL_DIR / "lgbm_final_model.joblib")
